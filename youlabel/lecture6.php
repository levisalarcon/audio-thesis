...
if (mysql_query("INSERT INTO Lecture6 VALUES('$start','$end','')"))    
   ...
   $data_query=mysql_query("SELECT start,end,segment from Lecture6");
   ...
   $data2_query2=mysql_query("SELECT start,end,segment from Lecture6");

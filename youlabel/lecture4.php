...
if (mysql_query("INSERT INTO Lecture4 VALUES('$start','$end','')"))    
   ...
   $data_query=mysql_query("SELECT start,end,segment from Lecture4");
   ...
   $data2_query2=mysql_query("SELECT start,end,segment from Lecture4");

...
if (mysql_query("INSERT INTO Lecture3 VALUES('$start','$end','')"))    
   ...
   $data_query=mysql_query("SELECT start,end,segment from Lecture3");
   ...
   $data2_query2=mysql_query("SELECT start,end,segment from Lecture3");

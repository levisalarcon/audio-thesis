...
[predicted,err,P,logp,coeff] = classify(validate_data,train_data,train_label,'diagquadratic'); 
...
[predicted,err,P,logp,coeff] = classify(test_data,train_data,train_label,'diagquadratic'); 
